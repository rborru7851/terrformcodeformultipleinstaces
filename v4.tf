...
resource "aws_instance" "ec2_instances" {
  ...
  network_interface {
    ...
    network_interface_id = var.instance_configs[count.index].vpc_interface ? aws_network_interface.vpc_interface.id : aws_network_interface.new_interface[count.index].id
